function [x_hat_1k, x_hat_var_1k, dMSE, dMSE_b] = BAd_GVAMP(Ai, A0, y, T_LMMSE, T_VN_denoising, x_true,b_true, NumBits,delta)
% Code for paper:"Bilinear Adaptive Generalized Adaptive Vector Approximate
% Message Passing", IEEE Access, 2018. 
% main function for BAd-GVAMP algorithm (L = 1 case)
